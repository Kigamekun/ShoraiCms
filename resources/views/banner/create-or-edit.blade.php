...
<br>
        ...
        <form action="{{ route('banner.update',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="Judul" class="form-label">Judul</label>
                <input type="text" class="form-control" id="Judul" name="judul" value="{{$data->judul}}" placeholder="isi Judul ">
              </div>
    ...
    <br>
              ...
              <input type="file" name="gambar" class="dropify"  data-default-file="{{ url('banner/'.$data->gambar) }}" data-max-width="2000" data-max-width="2000" />
